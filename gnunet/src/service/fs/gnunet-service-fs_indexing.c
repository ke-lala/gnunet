                                  ...
                                  void *cont_cls)
{
  ...
  char edata[DBLOCK_SIZE + sizeof (struct GNUNET_CRYPTO_AeadMac)];
  const char *fn;
  ...
  GNUNET_FS_hash_to_symmetric_key (&nkey, &skey, &iv);
  GNUNET_CRYPTO_aead_encrypt (nsize,
                              (unsigned char*) ndata,
                              0,
                              NULL,
                              &skey,
                              &iv,
                              edata,
                              (struct GNUNET_CRYPTO_AeadMac*) &edata[nsize]);
  GNUNET_CRYPTO_hash (edata,
                      nsize + sizeof (struct GNUNET_CRYPTO_AeadMac),
                      &query);
