...
{
  struct GNUNET_FS_Uri *ret;
  struct GNUNET_CRYPTO_EddsaPublicKey ns;
  size_t pos;
  const char *end;
 ...
 */
struct GNUNET_FS_Uri *
GNUNET_FS_uri_sks_create (const struct GNUNET_CRYPTO_EddsaPublicKey *ns,
                          const char *id)
{
...
GNUNET_FS_uri_sks_get_namespace (const struct GNUNET_FS_Uri *uri,
                                 struct GNUNET_CRYPTO_EddsaPublicKey *pseudonym)
{
