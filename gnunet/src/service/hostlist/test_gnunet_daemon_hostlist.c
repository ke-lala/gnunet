...
main (int argc, char *argv[])
{
  ...
  GNUNET_OS_purge_cfg_dir ("test_gnunet_daemon_hostlist_peer1.conf",
                             "GNUNET_TEST_HOME");
  GNUNET_OS_purge_cfg_dir ("test_gnunet_daemon_hostlist_peer2.conf",
                             "GNUNET_TEST_HOME");
  GNUNET_OS_purge_cfg_dir ("test_gnunet_daemon_hostlist_data.conf",
                             "GNUNET_TEST_HOME");
