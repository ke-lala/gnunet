...
#if defined(MICROHTTPD2_H) || defined(MICROHTTPD2_PORTABILITY_H)
#error the header "mhd_sys_options.h" must be included before any other header
#endif
...
// TODO: support warnings mute
#ifdef HAVE_ENUM_BASE_TYPE_WARNLESS
#  define mhd_USE_ENUM_BASE_T   1
#endif
#ifdef mhd_USE_ENUM_BASE_T
#  define mhd_ENUM_BASE_T(fixed_type) : fixed_type
#else
#  define mhd_ENUM_BASE_T(fixed_type) /* empty */
#endif
...
#    endif
#  endif
#  define mhd_ENUM_BASE_T(base) /* nothing */
